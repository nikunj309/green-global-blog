                ...
                <div className="flex flex-col  px-5 mt-16">
                    <div className="mt-14">
                        ...
                        <div className=" uppercase text-neutral-400 flex flex-col gap-5">
                            ...
                            <Link href="/Category/Heat Pumps">Heat Pumps</Link>
                            <Link href="/Category/Solar System">Solar System</Link>
                            <Link href="/Category/Wind Turbines">Wind Turbines</Link>
                            <Link href="/Category/Working Process">Working Process</Link>
                        </div>
                    </div>
