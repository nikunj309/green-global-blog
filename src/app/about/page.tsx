    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="relative bg-white ">
          <Image src={casestudy_1} alt="Case Study 1" className="w-full h-auto"/>
          <div className="absolute -bottom-16 left-5 right-5 bg-white p-2 shadow-lg">
            <h2 className="text-[#003D4D] text-2xl font-semibold text-center">Project Name</h2>
            <p className="text-gray-700 mt-2 text-sm text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed faucibus diam nec aliquam fermentum. Nullam at lorem vel erat tempor mollis.</p>
          </div>
        </div>
        <div className="relative bg-white">
          <Image src={casestudy_2} alt="Case Study 2" className="w-full h-auto"/>
          <div className="absolute -bottom-16 left-5 right-5 bg-white p-2 shadow-lg">
            <h2 className="text-[#003D4D] text-2xl font-semibold text-center">Project Name</h2>
            <p className="text-gray-700 mt-2 text-sm text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed faucibus diam nec aliquam fermentum. Nullam at lorem vel erat tempor mollis.</p>
          </div>
        ...
        <div className="relative bg-white">
          <Image src={casestudy_3} alt="Case Study 3" className="w-full h-auto"/>
          <div className="absolute -bottom-16 left-5 right-5 bg-white p-2 shadow-lg">
            <h2 className="text-[#003D4D] text-2xl font-semibold text-center">Project Name</h2>
            <p className="text-gray-700 mt-2 text-sm text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed faucibus diam nec aliquam fermentum. Nullam at lorem vel erat tempor mollis.</p>
          </div>
