...
import crumb from '@/assets/ProductScreenImages/image1.png';
import rubber from '@/assets/ProductScreenImages/image2.png';
import image3 from '@/assets/ProductScreenImages/image3.png';
...
const page = () => {
  const products = [
    {
      imageSrc: crumb,
      altText: 'Crumb Rubber Granules',
      title: 'Crumb Rubber Granules',
